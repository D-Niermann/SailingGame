...
var goods: Dictionary = {
	"banana": {"type": "food", "size": Vector3(2,1, 1), "price": 10, "weight": 1.0, "res": "res://GUINodes/BuildAndShop/exampleItem.tscn", "icon": "res://icon.png"},
	"apple": {"type": "food", "size": Vector3(2,1, 1), "price": 10, "weight": 1.0, "res": "res://GUINodes/BuildAndShop/exampleItem.tscn", "icon": "res://icon.png"},
	...
	"WallLong": {"type": "gear", "size": Vector3(1,2, 3), "price": 1, "weight": 1.0, "res": "res://ObjectNodes/Items/Walls/WallLong.tscn", "icon": "res://ObjectNodes/Items/Walls/Sprites/Wall.png"},
	"LightSmall": {"type": "gear", "size": Vector3(1,1, 1), "price": 1, "weight": 1.0, "res": "res://ObjectNodes/Items/Lights/Light1.tscn", "icon": "res://ObjectNodes/Items/Walls/Sprites/Wall.png"}
}
