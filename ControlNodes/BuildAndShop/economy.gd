...
var goods: Dictionary = { # TODO: RENAME INTO GEAR or ITEMS, this list is not about goods
	"banana"     : {"type": "food", "size": Vector3(2,1, 1), "penetrationFactor": 0.9, "jobs": {}, "maxHealth": 1, "isCannon" : false, "price": 10, "weight": 1.0, "res": "res://ControlNodes/BuildAndShop/exampleItem.tscn", "icon": "res://icon.png"},
	
	"apple"      : {"type": "food", "size": Vector3(2,1, 1), "penetrationFactor": 0.9, "jobs": {}, "maxHealth": 1, "isCannon" : false, "price": 10, "weight": 1.0, "res": "res://ControlNodes/BuildAndShop/exampleItem.tscn", "icon": "res://icon.png"},
	
	"CannonLarge": {"type": "gear", "size": Vector3(3,1, 2), "penetrationFactor": 0.3,
					"jobs": {"Gunner1": {"posOffset":Vector3(0,0,0.1), "tg": TG_WEAPONS, "priority" : 0}, "Gunner2": {"posOffset":Vector3(0,0,-0.1), "tg": TG_WEAPONS, "priority" : 1}},
	...
	"WallLong"   : {"type": "gear", "size": Vector3(1,2, 3), "penetrationFactor": 0.6, "jobs": {}, "maxHealth": 50, "isCannon" : false, "price": 1, "weight": 1.0, "res": "res://ObjectNodes/Items/Walls/WallLong.tscn", "icon": "res://ObjectNodes/Items/Walls/Sprites/Wall.png"},
	
	"LightSmall" : {"type": "gear", "size": Vector3(1,1, 1), "penetrationFactor": 0.9, "jobs": {}, "maxHealth": 3, "isCannon" : false, "price": 1, "weight": 1.0, "res": "res://ObjectNodes/Items/Lights/Light1.tscn", "icon": "res://ObjectNodes/Items/Walls/Sprites/Wall.png"}
}
